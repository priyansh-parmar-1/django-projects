...
SECRET_KEY = 'django-insecure-4-mbzwa=oou5b42n^zi=)^m_i+j)(_y@f)s&)pe$f8edi**&n%'
...
EMAIL_HOST_USER = 'mahima.carcastle@gmail.com'
EMAIL_HOST_PASSWORD ='bdfh jvvs lyop ljer'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
